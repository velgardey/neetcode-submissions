class Solution:
    def coinChange(self, coins: List[int], amount: int) -> int:
        ...
        return dp[amount] if dp[amount] != (amount + 1) else -1 # we are checking if the dp value on the amount index has been updated or not which tells us if a valid combination is present or not
